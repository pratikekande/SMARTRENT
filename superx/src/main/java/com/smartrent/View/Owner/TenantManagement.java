...
public class TenantManagement {
    ...
    private VBox createTenantCard(Flat flat) {
        ...
        // MODIFIED: The main title of the card is now the property location.
        Text cardTitle = new Text(flat.getSocietyName() + " - " + flat.getFlatNo());
        ...
        // ADDED: Tenant Name is now a labeled field inside the grid for consistency.
        detailsGrid.add(createDetailLabel("Tenant Name"), 0, 0);
        detailsGrid.add(createDetailValue(flat.getTenantName()), 1, 0);

        // MODIFIED: Row indices are shifted down by 1 to accommodate the new field.
        detailsGrid.add(createDetailLabel("Society Name"), 0, 1);
        detailsGrid.add(createDetailValue(flat.getSocietyName()), 1, 1);
        detailsGrid.add(createDetailLabel("Flat No"), 0, 2);
        detailsGrid.add(createDetailValue(flat.getFlatNo()), 1, 2);
        detailsGrid.add(createDetailLabel("Address"), 0, 3);
        detailsGrid.add(createDetailValue(flat.getAddress()), 1, 3);
        detailsGrid.add(createDetailLabel("Monthly Rent"), 0, 4);
        detailsGrid.add(createDetailValue("₹" + flat.getRent()), 1, 4);
        detailsGrid.add(createDetailLabel("Email Address"), 0, 5);
        detailsGrid.add(createDetailValue(flat.getTenantEmail()), 1, 5);
        ...
        // MODIFIED: Use the new cardTitle and add all elements to the card layout.
        card.getChildren().addAll(cardTitle, new Separator(), detailsGrid, buttonContainer);
        return card;
    }
