package com.smartrent.View.Owner.Component;
...
public class OSidebar extends VBox {

    private Button[] menuButtons;
    private final String[] menuItems = {
        "Owner Dashboard", "Tenant Management", "Rent Management", "Maintenance", "Logout"
    };
    ...
    public OSidebar(String activeItem) {
        setSpacing(20);
        setPrefWidth(200);
        ...
        // --- FIX 1: Set the initial state when the sidebar is created. ---
        ...
        profileImage.setClip(new Circle(80, 80, 120));
        ...
        for (int i = 0; i < menuItems.length; i++) {
            ...
            // Use the now-set currentActiveItem for initial styling
            ...
            btn.setOnMouseExited(event -> {
                // This logic will now work correctly because currentActiveItem is always up-to-date.
                btn.setStyle(item.equals(this.currentActiveItem) ? activeStyle : defaultStyle);
    ...
    /**
     * Highlights the specified menu item and sets all others to the default style.
     * @param activeItem The text of the button to highlight.
     */
    public void highlight(String activeItem) {
        // --- FIX 2: Update the state variable every time a new item is highlighted. ---
        this.currentActiveItem = activeItem;

        for (int i = 0; i < menuButtons.length; i++) {
            Button btn = menuButtons[i];
            if (menuItems[i].equals(this.currentActiveItem)) {
