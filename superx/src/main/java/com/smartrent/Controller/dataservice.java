...
public class dataservice {
    ...
    private static final String BUCKET = "Firebase-Bucket"; //YOUR FIREBASE BUCKET
    ...
    public ListenerRegistration listenForMaintenanceRequests(String ownerId, EventListener<QuerySnapshot> listener) {
        return db.collection("MaintenanceRequests")
                 .whereEqualTo("ownerId", ownerId)
                 .addSnapshotListener(listener);
    }
    
    public ListenerRegistration listenForMaintenanceRequestsForTenant(String tenantId, EventListener<QuerySnapshot> listener) {
        return db.collection("MaintenanceRequests")
    ...
    /**
     * NEW: Attaches a real-time listener for payments for a specific owner.
     * @param ownerId The owner's ID to filter payments by.
     * @param listener The event listener to handle updates.
     * @return A ListenerRegistration that can be used to detach the listener.
     */
    public ListenerRegistration listenForPayments(String ownerId, EventListener<QuerySnapshot> listener) {
